var FindingObservation={
    ...
    "subject": {
      "reference": "Patient/10328881",
      "display": "林睿杰"
    },
    "effectiveDateTime": "2015-02-07T13:28:17-05:00",
    "performer": [ {
      "reference": "Practitioner/10328902",
...
function Submit(){
    // FindingObservation.component[1].valueInteger=document.getElementsByName("Aantal keer bekeken")[0].value;
    // FindingObservation.component[2].valueString=document.getElementsByName("Aantal keer bekeken - tekst")[0].value;
    // FindingObservation.component[3].valueString=document.getElementsByName("Klinische informatie")[0].value;
    // FindingObservation.component[4].valueString=document.getElementsByName("Vergelijking")[0].value;
